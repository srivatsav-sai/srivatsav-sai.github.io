...
const Resume = () => {
  return (
    <div className="container resume-section">
      ...
      <div>
        <p>To know more about my projects, check out my Resume below.</p><a class="btn btn-link" href={process.env.PUBLIC_URL + '/Srivatsav Resume.pdf'} target='_blank'  role="button">Resume</a> 
      </div>
      {/* <div>
      <PDFViewer>
        <MyDocument />
