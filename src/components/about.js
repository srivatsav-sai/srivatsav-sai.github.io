...
const About = () => {
  return (
    <div className="container home-section">
      <div><Header/></div>
      <h1>About Me</h1>
      <p>I'm a Versatile Junior Full Stack Developer with a solid foundation in JavaScript and its frameworks such as ReactJS and AngularJS. Adaptable and solutions-focused, with a demonstrated history of contributing to collaborative environments and projects, and a commitment to continuous learning and professional growth.</p>
